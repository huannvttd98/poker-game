...
const LANGS = {
  vi: {
    ...
    enterLobby: 'Vao sanh',
    // Login
    loginTitle: 'Dang nhap de choi',
    loginSubtitle: 'Xac thuc qua Telegram',
    loginChecking: 'Dang kiem tra...',
    loginVerifying: 'Dang xac minh...',
    loginAuthFailed: 'Xac thuc that bai. Thu lai.',
    loginNotConfigured: 'Server chua cau hinh Telegram bot. Lien he admin.',
    loginConfigError: 'Khong ket noi duoc server',
    loginWidgetError: 'Khong tai duoc Telegram widget (can HTTPS + domain)',
    qrOpenInTelegram: 'Mo Telegram',
    qrHint: 'Quet QR bang app Telegram, hoac bam nut tren neu dang dung Telegram tren may nay',
    qrWaiting: 'Dang cho xac nhan...',
    loggedInAs: 'Da dang nhap',
    logout: 'Dang xuat',
    // Lobby
    editProfile: 'Sua',
    ...
    log: 'Nhat ky',
    downloadLog: '⬇ Tai log',
    logPickTitle: 'Chon file log de tai:',
    logEmpty: 'Chua co file log nao',
    logFetchError: 'Khong tai duoc danh sach log',
  ...
  en: {
    ...
    loginSubtitle: 'Authenticate via Telegram',
    loginChecking: 'Checking...',
    loginVerifying: 'Verifying...',
    loginAuthFailed: 'Authentication failed. Try again.',
    loginNotConfigured: 'Telegram bot not configured on server. Contact admin.',
    loginConfigError: 'Cannot reach server',
    loginWidgetError: 'Cannot load Telegram widget (needs HTTPS + domain)',
    qrOpenInTelegram: 'Open in Telegram',
    qrHint: 'Scan the QR with Telegram app, or tap the button if you have Telegram on this device',
    ...
    logPickTitle: 'Pick a log file to download:',
    logEmpty: 'No log files yet',
    logFetchError: 'Cannot load log list',
